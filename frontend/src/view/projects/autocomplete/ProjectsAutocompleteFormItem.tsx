...
import ProjectsFormModal from 'src/view/projects/form/ProjectsFormModal';
...
const ProjectsAutocompleteFormItem = (props) => {
  ...
  const fetchFn = (value, limit) => {
    return ProjectsService.listAutocomplete(value, limit);
  };
...
export default ProjectsAutocompleteFormItem;
